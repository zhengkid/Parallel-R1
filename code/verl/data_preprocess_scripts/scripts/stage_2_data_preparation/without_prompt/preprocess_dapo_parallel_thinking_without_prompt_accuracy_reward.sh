...
OUTPUT_dir="data/APO_combine/adaptive_parallel_thinking_final_no_prompt/rl_all_accuracy_reward"
...
TEMPLATE_FILE="../prompts/adaptive_parallel_thinking-no-prompt.txt"
OUTPUT_dir="data/dapo/adaptive_parallel_thinking_final_no_prompt/rl_all_accuracy_reward"
SPLIT="train"            # 可选，默认 train
REWARD_METHOD="accuracy_reward" #"accuracy_times_special_token_reward_times_format"
# 如果目录不存在就创建
if [ ! -d "$OUTPUT_dir" ]; then
