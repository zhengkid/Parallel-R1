...
def default_compute_score(
    ...
    elif data_source == "math_dapo" or data_source.startswith("aime") or "APO" in data_source:
        if extra_info['reward_method'] == 'accuracy_reward':
            from . import math_dapo
            res = math_dapo.compute_score(solution_str, ground_truth)
        elif extra_info['reward_method'] == 'format_accuracy_parallel_reward':
            from . import math_dapo_accuracy_format_parallel
            res = math_dapo_accuracy_format_parallel.compute_score(solution_str, solution_str_with_special_tokens, ground_truth)
    elif data_source in [
        "numina_aops_forum",
