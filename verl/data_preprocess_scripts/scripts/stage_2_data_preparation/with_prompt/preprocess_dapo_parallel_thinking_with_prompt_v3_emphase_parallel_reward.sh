...
OUTPUT_dir="data/APO_combine/adaptive_parallel_thinking_final_with_prompt_v3/rl_all_emphase_parallel_reward"
SPLIT="train"            # 可选，默认 train
REWARD_METHOD="emphase_parallel" #"accuracy_times_special_token_reward_times_format"
...
TEMPLATE_FILE="../prompts/adaptive_parallel_thinking_v3.txt"
OUTPUT_dir="data/dapo/adaptive_parallel_thinking_final_with_prompt_v3/rl_all_emphase_parallel_reward"
SPLIT="train"            # 可选，默认 train
REWARD_METHOD="emphase_parallel" #"accuracy_times_special_token_reward_times_format"
# 如果目录不存在就创建
if [ ! -d "$OUTPUT_dir" ]; then
