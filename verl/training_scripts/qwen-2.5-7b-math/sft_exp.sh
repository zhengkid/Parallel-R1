...
save_dir_root=/beacon-projects/ihc-huang/tong/
experiment_name=Parallel-SFT-Unseen-qwen2.5-7b-base
...
torchrun --standalone --nnodes=1 --nproc_per_node=$nproc_per_node \
    ...
    model.partial_pretrain=Parallel-R1/Qwen2.5-Math-7B-add-special-token \
